(() => {
  ...
  const ITEM_CATALOG = {
    ...
    FKM_Case_Nova_Locked:{name:"Caisse de couteau Nova",image:"SenzanyReward.png",description:"Caisse de couteau verrouillée. Livrée avec un dispositif de déchiffrement."},
    FKM_Decryption_Device:{name:"Clé de déchiffrement",image:"SenzanyReward.png",description:"Dispositif de déchiffrement livré avec chaque caisse de couteau."},
